...
class EnterWindow(QWidget):
    ...
    def initUi(self):
        ...
        # Заголовок
        title_label = QLabel("Пройдите аутентификацию")
    ...
    def check_enter(self):
        if self.login_edit.text() == "Magnetik" and self.password_edit.text() == "147369":
            self.menuWin = menu.MenuWindow()
            self.menuWin.show()
            self.close()
        else:
            self.help_label.setText("Неверный логин или пароль")
